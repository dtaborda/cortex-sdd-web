  ...
  slides: [
    {
      ...
      visualData: {
        stages: [
          { label: "Fresh chat", quality: 98, tokens: "2K" },
          { label: "Multi-tasking", quality: 60, tokens: "50K" },
          { label: "Context swamp", quality: 30, tokens: "100K" },
          { label: "Collapse", quality: 10, tokens: "180K" },
        ],
      },
    ...
    },
    {
      ...
      visualData: {
        center: { label: "Project", color: "#F97316" },
        connections: [
          { label: "DB Context", direction: "out", description: "Schema design" },
          { label: "API Context", direction: "out", description: "Endpoints & logic" },
          { label: "UI Context", direction: "out", description: "Components & UX" },
          { label: "Test Context", direction: "out", description: "Testing & QA" },
          { label: "Deploy Context", direction: "out", description: "CI/CD & config" },
        ],
      },
